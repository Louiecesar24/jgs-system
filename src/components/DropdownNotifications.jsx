							...
							<Link
								...
								<span className='block text-sm mb-2'>
									...
									<span className='font-medium text-slate-800 dark:text-slate-100'>
										If errors persist while operating
									</span>{" "}
									Contact the developer of the POS. Reminder that he may not be available
									ANYTIME but he will try to reach out ASAP.
								</span>
						...
						<li className='border-b border-slate-200 dark:border-slate-700 last:border-0'>
							<Link
								...
								<span className='block text-sm mb-2'>
									📣{" "}
									<span className='font-medium text-slate-800 dark:text-slate-100'>
										Manage your POS accordingly.
									</span>{" "}
									This POS is crafted with love and care. Thus, manage it accordingly.
								</span>
								<span className='block text-xs font-medium text-slate-400 dark:text-slate-500'>
									Francis Tin-ao
								</span>
